...
space *do not upload these to the placeh.io server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the placeh.io server
...
people without access to `placeh.io` to download the binary distribution.
Also put it into the `optional_magnetlink:` slot in the YAML file for
placeh.io (see below for placeh.io update instructions).
