placeh Core version 0.13.2 is now available from:

  <https://placeh.org/bin/placeh-core-0.13.2/>
...
- #8908 `4a974b2` Update placeh-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow placeh-tx to create v2 transactions (btcdrak)
