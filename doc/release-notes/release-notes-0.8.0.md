placeh-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/placeh/files/placeh/placeh-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the placeh
...
New/changed settings (command-line or placeh.conf file)
--------------------------------------------------------
