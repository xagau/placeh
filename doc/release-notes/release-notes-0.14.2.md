placeh Core version 0.14.2 is now available from:

  <https://placeh.org/bin/placeh-core-0.14.2/>
...
(in placeh Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in placeh-Qt when using coin
...
- #10228 `ae479bc` Regenerate placeh-config.h as necessary (theuni)
