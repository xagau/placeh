Download URL: https://sourceforge.net/projects/placeh/files/placeh/placeh-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 PHL fee schedule (users still pay 0.01 PHL per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #placeh00 - #placeh99
