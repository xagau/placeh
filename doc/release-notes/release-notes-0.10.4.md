placeh Core version 0.10.4 is now available from:

  <https://placeh.org/bin/placeh-core-0.10.4/>
...
- #6953 `43c2789` Split placeh-tx into its own package
- #6953 `dfe0d4d` Include placeh-tx binary on Debian/Ubuntu
