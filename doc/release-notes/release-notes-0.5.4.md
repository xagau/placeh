placeh version 0.5.4 is now available for download at:
http://sourceforge.net/projects/placeh/files/placeh/placeh-0.5.4/
...
http://gitorious.org/placeh/placehd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix placeh-Qt notifications under Growl 1.3.
Increase required age of placeh-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxplaceh properly when installing placeh-Qt over it. (Windows)
