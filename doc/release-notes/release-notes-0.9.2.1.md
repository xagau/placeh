placeh Core version 0.9.2.1 is now available from:

  https://placeh.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PHL to 0.01 PHL
...
- Fix "Start placeh on system login"
