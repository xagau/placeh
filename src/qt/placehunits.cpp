...
placehUnits::placehUnits(QObject* parent) : QAbstractListModel(parent),
...
QString placehUnits::description(int unit)
{
    switch (unit) {
    case PHL:
        return QString("placehs");
    case mPHL:
        return QString("Milli-placehs (1 / 1" THIN_SP_UTF8 "000)");
    case uPHL:
        return QString("Micro-placehs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default:
        return QString("???");
    }
}
...
QString placehUnits::format(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators)
{
