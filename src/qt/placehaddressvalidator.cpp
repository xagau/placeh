...
placehAddressEntryValidator::placehAddressEntryValidator(QObject* parent) : QValidator(parent)
{
}
...
placehAddressCheckValidator::placehAddressCheckValidator(QObject* parent) : QValidator(parent)
{
}
...
QValidator::State placehAddressCheckValidator::validate(QString& input, int& pos) const
{
    ...
    CplacehAddress addr(input.toStdString());
    if (addr.IsValid())
