...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 PHL"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 PHL"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 PHL"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 PHL"));
        ...
        customFee = new placehAmountField(frameFeeSelection);
        ...
        labelBalance->setText(QStringLiteral("123.456 PHL"));
...
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for placeh transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for placeh transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
