...
public:
    ...
    QPushButton *openplacehConfButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        placehAtStartup = new QCheckBox(tabMain);
        placehAtStartup->setObjectName(QStringLiteral("placehAtStartup"));

        verticalLayout_Main->addWidget(placehAtStartup);
        ...
        openplacehConfButton = new QPushButton(OptionsDialog);
        openplacehConfButton->setObjectName(QStringLiteral("openplacehConfButton"));
        openplacehConfButton->setAutoDefault(false);

        verticalLayout_Buttons->addWidget(openplacehConfButton);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        placehAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start %1 after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        placehAtStartup->setText(QApplication::translate("OptionsDialog", "&Start %1 on system login", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the placeh client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the placeh network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the placeh network through a separate SOCKS5 proxy for Tor hidden services.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        openplacehConfButton->setToolTip(QApplication::translate("OptionsDialog", "Open the %1 configuration file from the working directory.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        openplacehConfButton->setText(QApplication::translate("OptionsDialog", "Open Configuration File", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
