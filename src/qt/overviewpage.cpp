...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(const PlatformStyle* _platformStyle, QObject* parent = nullptr) : QAbstractItemDelegate(parent), unit(placehUnits::PHL),
    ...
    inline void paint(QPainter* painter, const QStyleOptionViewItem& option, const QModelIndex& index) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = placehUnits::formatWithUnit(unit, amount, true, placehUnits::separatorAlways);
        if (!confirmed) {
