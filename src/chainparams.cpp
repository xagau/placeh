...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("testnet-seed.placeh.jonasschnelli.ch", true);
...
public:
    CRegTestParams()
    {
        ...
        consensus.BIP34Height = 500; // This is deactivated on placeh, but we activate it on the fork block here, as we otherwise won't get the fork hash coinbase
