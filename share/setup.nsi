...
!define MUI_ICON "/mnt/c/git/repo/placeh/share/pixmaps/placeh.ico"
!define MUI_WELCOMEFINISHPAGE_BITMAP "/mnt/c/git/repo/placeh/share/pixmaps/nsis-wizard.bmp"
!define MUI_HEADERIMAGE
!define MUI_HEADERIMAGE_RIGHT
!define MUI_HEADERIMAGE_BITMAP "/mnt/c/git/repo/placeh/share/pixmaps/nsis-header.bmp"
...
OutFile /mnt/c/git/repo/placeh/placeh-${VERSION}-win32-setup.exe
!if "32" == "64"
...
VIAddVersionKey ProductName "placeh core"
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\placeh core (testnet, 32-bit).lnk" "$INSTDIR\placeh-qt.exe" "-testnet" "$INSTDIR\placeh-qt.exe" 1
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\placeh core (testnet, 32-bit).lnk"
