...
unlocked to sign the placeh-Qt.app bundle.
...
allowing somebody to distribute a placeh-Qt.app or placeh-qt-setup.exe with a valid
...
that the placeh-qt.exe file inside the installer had not been tampered with.
